...
class MascotaAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'especie', 'genero', 'edad', 'tamaño', 'ubicacion', 'propietario', 'fecha_creacion')
    list_filter = ('especie', 'genero', 'tamaño', 'necesidades_especiales', 'convivencia_animales', 'convivencia_ninos', 'ubicacion', 'fecha_creacion')
